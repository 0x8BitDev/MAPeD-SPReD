...
namespace MAPeD
{
	...
	public static class utils
	{
		...
		public static int get_palette_len_by_file_ext( string _file_ext )
		{
			switch( _file_ext )
			{
				case CONST_NES_FILE_EXT:
					{
						return CONST_NES_PALETTE_NUM_COLORS;
					}
					break;
					
				case CONST_SMS_FILE_EXT:
					{
						return CONST_SMS_PALETTE_NUM_COLORS;
					}
					break;
					
				case CONST_PCE_FILE_EXT:
					{
						return CONST_PCE_PALETTE_NUM_COLORS;
					}
					break;
			}
		...
		public static int get_scr_tiles_cnt_by_file_ext( string _file_ext )
		{
			...
			throw new Exception( "utils.get_scr_tiles_cnt_by_file_ext(...) : invalid parameter!" );
		}
		
		private static int[] NES_palette = new int[]{ 	0x7C7C7C, 0x0000FC, 0x0000BC, 0x4428BC, 0x940084, 0xA80020, 0xA81000, 0x881400,
		...
		private static int[] SMS_palette = new int[]{ 	0x000000, 0x550000, 0xaa0000, 0xff0000,	0x005500, 0x555500, 0xaa5500, 0xff5500,
