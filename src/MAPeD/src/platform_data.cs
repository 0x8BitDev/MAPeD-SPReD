...
namespace MAPeD
{
	...
	public static class platform_data
	{
		...
		private const int CONST_PCE_SCREEN_NUM_TILES_WIDTH	= 10;
		...
		private const int CONST_PCE_SCREEN_NUM_TILES_HEIGHT	= 8;
		...
		private const int CONST_PCE_SCREEN_NUM_BLOCKS_HEIGHT	= ( CONST_PCE_SCREEN_NUM_TILES_HEIGHT << 1 ) - 1;
