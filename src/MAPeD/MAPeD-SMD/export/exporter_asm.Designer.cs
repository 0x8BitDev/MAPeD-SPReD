...
namespace MAPeD
{
	partial class exporter_asm
	{
		...
		private void InitializeComponent()
		{
			...
			this.CheckBoxExportSGDKData = new System.Windows.Forms.CheckBox();
			...
			// groupBox2
			// 
			this.groupBox2.Controls.Add(this.CheckBoxExportSGDKData);
			...
			// 
			// CheckBoxExportSGDKData
			// 
			this.CheckBoxExportSGDKData.Checked = true;
			this.CheckBoxExportSGDKData.CheckState = System.Windows.Forms.CheckState.Checked;
			...
			this.CheckBoxExportSGDKData.CheckedChanged += new System.EventHandler(this.OnParamChanged);
			// 
			// groupBox6
			// 
			this.groupBox6.Controls.Add(this.ComboBoxInFrontOfSpritesProp);
