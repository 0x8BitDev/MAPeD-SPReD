...
//	- entities (map coordinates)/no sorting
...
#define FLAG_ENTITIES                 1
#define FLAG_ENTITY_SCR_COORDS        0
#define FLAG_ENTITY_MAP_COORS         1
#define FLAG_ENTITY_SORTING_OFF       1
