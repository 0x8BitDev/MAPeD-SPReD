...
.define		MAP_CHECK(arg) ( ::MAP_DATA_MAGIC & arg )
	...
	.IF MAP_CHECK(::MAP_FLAG_MODE_MULTIDIR_SCROLL) || MAP_CHECK(::MAP_FLAG_MODE_BIDIR_SCROLL)
	.IF ::SCR_BLOCKS2x2_WIDTH <> 16 || ::SCR_BLOCKS2x2_HEIGHT <> 15
	.fatal "This sample requires full screen data (blocks 2x2: 16x15)!"
	.ENDIF
	.ENDIF
