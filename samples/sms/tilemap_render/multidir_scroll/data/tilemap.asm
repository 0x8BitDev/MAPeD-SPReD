...
Lev0_CHR:	.incbin "tilemap_Lev0_CHR.bin"		; (6208)
Lev0_Tiles:	.incbin "tilemap_Lev0_Tiles.bin"	; (392) (4x4) 4 block indices per tile ( left to right, up to down )
Lev0_Attrs:	.incbin "tilemap_Lev0_Attrs.bin"	; (1032) attributes array per block ( 2 bytes per attribute; 8 bytes per block )
...
.define Lev0_CHR_data_size	6208
