...
MS_16b		equ	1
MS_8b		equ	2
MS_4b		equ	3	; vertical scrolling is "free", horizontal one is simple RLD, so it's quite slow implementation, just to get fast result
		...
		DEFINE	DEF_MOVE_STEP		MS_8b	; MS_16b / MS_8b / MS_4b
